...
public class NavigationDrawerActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.btn_perfilUser) {
            Intent i = new Intent(NavigationDrawerActivity.this,PerfilClienteActivity.class);
            startActivity(i);
        } else if (id == R.id.btn_notificaciones) {
            Intent i = new Intent(NavigationDrawerActivity.this,NotificacionClienteActivity.class);
            startActivity(i);
        } else if (id == R.id.btn_config) {
            //Intent i = new Intent(NavigationDrawerActivity.this,.class);
            //startActivity(i);
